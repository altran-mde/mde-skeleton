...
In this example both the https://repo1.maven.org/maven2/[Maven central] as the https://download.eclipse.org/releases/2020-06/202006171000[Eclipse 2020-06 P2] repositories are rerouted to the ACIDSpace repository proxies.

[[source-settings-xml-mirrors]]
.Defining mirrors in link:{giturl}/settings.xml[settings.xml^]
[source,xml]
----
