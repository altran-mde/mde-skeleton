...
In this example, the https://gitlab.acidspace.nl/ec-mde/larch[LArch] repository is used as an example and the callouts below the listing explain the steps in more detail.
