...
ifndef::gitproject[:gitproject: cge-coe-mde/mde-skeleton]
ifndef::gitbranch[:gitbranch: develop]
ifndef::gitblob[:gitblob: https://gitlab.acidspace.nl/{gitproject}/-/blob]
ifndef::giturl[:giturl: {gitblob}/{gitbranch}]
