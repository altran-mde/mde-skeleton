...
The example below shows how to use Espilce Polvi to implement a Java code generator.
...
<3> The file is generated using the `URIBasedFileSystemAccess` instance that is created in step 1.

For more information on how to implement model-to-text generators with Xtend, please read the 
https://gitlab.acidspace.nl/ec-mde/xtend-based-generators/-/blob/master/xtend-based-generators/doc/xtend-based-generators.adoc[Xtend-based Model-to-Text Generators Guide].
